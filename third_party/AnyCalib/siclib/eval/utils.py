...
def download_and_extract_benchmark(name: str, url: str, output: Path) -> None:
    ...
    if name == "stanford2d3d" or name == "stanford2d3d_edit":
...
def plot_scatter_grid(
    ...
    for j, kx in enumerate(x_keys):
        for i, ky in enumerate(y_keys):
            ...
            means_x = [means["x"][kx]]
            means_y = [means["y"][ky]]
            color = plt.cm.tab10(line_idx)  # type:ignore
